<template>
    <div class="login" >
        <header>
            ...
            <p class="account-instro">Enter your email address and we'll send you instructions on how to reset your password</p>
        </header>
        <section>
    ...
    export default {
        ...
        methods: {
            ...
            async submits () {
                ...
                this.btn = true
                try {
                    await this.fwd(this.user.username)
                    this.$router.push('/check/' + this.user.username)
                } catch (e) {
                    alert(e.msg)
                }
                this.btn = false
